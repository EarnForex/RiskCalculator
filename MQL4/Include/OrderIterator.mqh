...
public:
   ...
   COrderIterator(void): Status(NULL), RO(NULL), current_price(0), unrealized_profit(0), realized_profit(0), mode(Risk) {Status = new COrderMap; RO = new COrderMap;}
  ~COrderIterator(void);
...
{
   Status = new COrderMap; RO = new COrderMap;
